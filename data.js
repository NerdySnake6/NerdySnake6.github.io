...
const siteData = {
  ...
  projects: {
    ...
    items: [
      ...
      {
        title: "Трамплин",
        task: "MVP карьерной платформы для студентов, выпускников, работодателей и кураторов. Сервис объединяет вакансии, стажировки, менторские программы и карьерные события в единой витрине и на карте.",
        ...
        result: "Проект доведен до полноценной демонстрации как рабочая карьерная площадка с картой и лентой возможностей.",
        links: [
          {
            label: "Live demo",
